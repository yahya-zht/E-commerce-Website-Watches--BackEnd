...
Route::get('categories/{id}', [GuestController::class, 'ShowCategory']);

Route::get('products/search/{query}', [ProductController::class, 'searchName']);
...
Route::post('Categories/search/Products', [GuestController::class, 'searchIdCategories']);
